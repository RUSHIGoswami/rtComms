...
202 155 294 129 162 316 273 528 311 89 16 269 4 368 -25z" />
    ...
    <main class="main-content">
        <div class="call-wrap-rtchat">
            <div class="user-connected-rtchat">
                <div class="u-connected-wrapper">
                    <img style="border-radius:50%" width="40px" height="40px" src="<?= url_for($profileData->profile_img); ?>" alt="<?= $profileData->fname . ' ' . $profileData->lname; ?>">
                </div>
                <span class="u-connected-name-rtchat"><?= $profileData->fname . ' ' . $profileData->lname; ?></span>
                <div class="u-icons-rtchat">
                    <a href="<?= url_for($profileData->uname . '/videochat'); ?>" data-profileid="<?= $profileData->uid; ?>">
            ...
            <div class="rtchat">
                <span class="chat local-chat">Hello</span>
                <span class="chat remote-chat">Hi!!!</span>
            </div>
            <div class="chat-actions">
                <input type="text" class="rt-chat" placeholder="Type your message">
                <span class="sendBtn"><input type="submit" class="fa fa-paper-plane sendChat" value="&#xf1d8"></span>
