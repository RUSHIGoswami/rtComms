...
?>
<div class="u-p-id" data-userid="<?= $userData->uid; ?>" data-profileid=""></div>
    ...
    <main class="main-content">
        <div class="webcam-container">
            <div class="webcam-img">
                <img src="<?= url_for("assets/images/web_cam_w.png"); ?>" alt="Web Cam Image">
            </div>
            <div class="sub-title-web">
                Keep your Webcam connected...
            </div>
            <div class="sub-para">
                This app allows users to video chat with other users.
            </div>
        </div>
    </main>
</section>
